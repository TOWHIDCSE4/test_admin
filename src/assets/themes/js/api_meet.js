!(function (e, t) {
    ...
    return (function (e) {
        ...
        function (e, t) {
            ...
            function s() {
                ...
                return (
                    ...
                    !r || r.length <= 4
                        ? (0 === n[2].indexOf('log@')
                              ? (e.methodName = n[3].substr(
                                    0,
                                    n[3].indexOf('@')
                                ))
                              : (e.methodName = n[2].substr(
                                    0,
                                    n[2].indexOf('@')
                                )),
                          e)
        ...
        function (e, t, n) {
            ...
            ;(t.parse = function (e, ...n) {
                const i = 'object' == typeof n[0] && n[0],
                    ...
                    o = (n.length > 1 && n[1]) || i || {},
                    a = JSON.parse(e, s)
                return 'ignore' === o.protoAction
                    ? a
                    : a && 'object' == typeof a && e.match(r)
                    ? (t.scan(a, o), a)
                    : a
            }),
                (t.scan = function (e, t = {}) {
        ...
        function (e, t, n) {
            ...
            e.exports = {
                ...
                getLogger: function (e, t, n) {
                    var i = new r(a, e, t, n)
                    return (
                        e ? ((s[e] = s[e] || []), s[e].push(i)) : o.push(i), i
                    )
                },
        ...
        function (e, t, n) {
            ...
            function d(e, t = !1, n = 'hash') {
                ...
                return (
                    s.forEach((e) => {
                        const n = e.split('='),
                            r = n[0]
                        if (!r || r.split('.').some((e) => u.includes(e)))
                            return
                        let s
                        try {
                            if (((s = n[1]), !t)) {
                            ...
                            return void (function (e, t = '') {
                                console.error(t, e),
                                    window.onerror &&
                                        window.onerror(t, null, null, null, e)
                            })(
                                e,
                                'Failed to parse URL parameter value: ' +
                                    String(s)
                            )
                        }
                        i[r] = s
            ...
            function h(e) {
                ...
                if (n) {
                    ...
                    'http:' !== r && 'https:' !== r && (r = 'https:'),
                        (e = e.substring(t.lastIndex)).startsWith('//') &&
                            (e = r + e)
                }
                return e
            }
            ...
            const b = { window: window.opener || window.parent }
            class w {
            ...
            const O = d(window.location).jitsi_meet_external_api_id,
                x = {}
            let j
            'number' == typeof O && (x.scope = 'jitsi_meet_external_api_' + O),
            ...
            class M extends i.a {
                    ...
                    this._transport.on('event', (e) => {
                        ...
                        switch (t) {
                            ...
                            case 'participant-joined':
                                ;(this._participants[r] =
                                    this._participants[r] || {}),
                                    (this._participants[r].displayName =
                                        n.displayName),
                                    (this._participants[
                                        r
                ...
                executeCommand(e, ...t) {
                    e in I
                        ? this._transport.sendEvent({ data: t, name: I[e] })
