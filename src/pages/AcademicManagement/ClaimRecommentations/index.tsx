...
const UserReport = ({ ...props }) => {
    const [values, setValues] = useReducer(
        (state, newState) => ({ ...state, ...newState }),
        {
            ...
            objectSearch: {
                ...
                recommend_status: '',
                recommend_section: '',
                processing_department_id: DEPARTMENT.hocthuat.id
            },
            hiddenColumns: {
                created_time: false,
                created_user: false,
    ...
    const getReports = ({ page_size, page_number, objectSearch }) => {
        objectSearch.processing_department_id = DEPARTMENT.hocthuat.id
    ...
    const columns: any = [
        ...
        },
        {
            ...
            render: (text, record: any) => {
                if (text)
                    return (
                        <>
                            <p className='d-flex'>{`${text?.fullname} - ${text?.username}`}</p>
                        </>
                    )
            }
        },
        ...
        },
        {
            ...
            fixed: 'right',
            render: (text, record: any) =>
                checkPermission(PERMISSIONS.amcr_update) && (
