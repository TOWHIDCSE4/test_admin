...
import UpdateCheckingCallModal from './modals/UpdateCheckingCallModal'
...
const CheckingCall = ({ ...props }) => {
    ...
    const getAllCheckingCall = ({ page_size, page_number, objectSearch }) => {
        ...
        RegularCareAPI.getAllCheckingCall(searchData)
            .then((res) => {
                let { total } = values
    ...
    const onClickUpdateData = async (item: any) => {
        ...
        const dataCheckingCall = {
            _id: data._id,
            status: data.status,
            detail_checking: data.detail_checking,
            note_history: data.note_history,
            username_student: data.user ? data.user.username : null
        }
        setValues({ selectedCheckingCall: dataCheckingCall })
    }
    ...
    return (
        <Card title='Checking Call'>
            ...
            />
            <UpdateCheckingCallModal
                visible={isShownModal}
                toggleModal={toggleModal}
                data={values.selectedCheckingCall}
