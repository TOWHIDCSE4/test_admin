    ...
    useEffect(() => {
        if (visible && !_.isEmpty(data)) {
            form.setFieldsValue({
                ...
                //     data?.learning_medium_type ?? EnumLearningMediumType.SKYPE
            })
            getCountries()
            getTimeZones()
        }
            ...
            >
                ...
                {/* <Row>
                    <Col span={8}>
                        <Form.Item
                            labelAlign='left'
                            name='learning_medium_type'
                            label='Learning medium type'
                        >
                            <Select
                                defaultValue={EnumLearningMediumType.SKYPE}
                                placeholder='Learning medium type'
                                style={{ width: '100%' }}
                            >
                                <Option value={EnumLearningMediumType.SKYPE}>
                                    Skype
                                </Option>
                                <Option value={EnumLearningMediumType.HMP}>
                                    Hamia meet plus
                                </Option>
                            </Select>
                        </Form.Item>
